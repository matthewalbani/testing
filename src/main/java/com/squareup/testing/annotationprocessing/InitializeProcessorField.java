 ...
 * {@linkplain Processor#init(ProcessingEnvironment) initialized} with the current {@link
 * ProcessingEnvironment} prior to running each test case.
 *
 ...
 * processor programmatically in a {@link org.junit.Before @Before} method.
 *
